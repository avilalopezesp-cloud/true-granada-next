  ...
  return (
    <section className="bg-cream2 py-[100px]">
      <div className="mx-auto max-w-[1160px] px-7">
        ...
        <h2 className="my-3.5 mb-14 text-center font-serif text-[clamp(1.8rem,3.5vw,2.6rem)] font-medium">¿Cómo funciona?</h2>
        <div className="reveal-group relative grid grid-cols-4 max-[680px]:grid-cols-2">
          ...
          {STEPS.map((step) => (
            <div key={step.n} className="reveal relative z-10 px-4 text-center">
              <div className="mx-auto mb-[18px] flex h-14 w-14 items-center justify-center rounded-full border-[1.5px] border-black/10 bg-paper font-serif text-xl font-medium text-gold2">
                {step.n}
              </div>
